...
- 다음과 같은 순서로 pruning을 수행함.
    ...
    2. mini-batch sampling $\mathcal{D}^b=\{(\mathbf{x}_i, \mathbf{y}_i)\}^{b}_{j=1} \sim\mathcal{D}$
...
![exp1](https://jerogar.github.io/img/PR113/SNIP/exp1.png)

- random label을 적용한 결과 pruned network의 경우 loss가 감소하지 않음. 
→ network의 memorization 문제를 방지할 수 있음

![exp2](https://jerogar.github.io/img/PR113/SNIP/exp2.png)
